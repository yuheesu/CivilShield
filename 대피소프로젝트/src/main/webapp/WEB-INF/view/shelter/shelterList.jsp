...
<html>
	<head>
		...
		function fn_goDetail(seq){
			...
			var form = document.getElementById("ShelterVO");
			form.action = "/shelterModal.do";
			form.submit();
		}
	...
	<body>
		<form:form commandName="ShelterVO" method="post" onsubmit="return false;">
	                ...
	                <div class="panel-body">                	
	                    <div class="dataTable_wrapper">
	                        <table class="table table-striped table-bordered table-hover dt-responsive" id="dataTables-ex04" width="100%" 
	                            ...
	                            <tbody>							
					            <c:forEach var="list" items="${shelterModelList}" varStatus="status">
						            <tr>
