...
<html>
	<head>
		...
		function member_create(){
			location.href="/gsitm/writemember.do";
		}
		
		
		function dept_view(){
			location.href="/gsitm/viewdept.do";
		}
		</script>
	</head> 
	<body>
		...
		<div class="row">
	        <div class="col-lg-12">
	            ...
	            <div class="panel panel-default">
	                <div class="panel-heading">회원 목록조회</div>
	                <!-- /.panel-heading -->
	                <div class="panel-body">                	
	                        ...
	                        <table class="table table-striped table-bordered table-hover dt-responsive" id="dataTables-ex04" width="100%" 
	                            ...
	                            <thead>
	                                <tr>	
	                                    ...
	                                    <th class="text-center" width="*">이름</th>
	                                    <th class="text-center" width="*">부서번호</th>
	                                </tr>
	                            </thead>
	                            <tbody>							
					            <c:forEach var="list" items="${memberModelList}" varStatus="status">
						            <tr>
										<td class="text-center" style="vertical-align:middle;">						
												${list.memberNo}							
										</td>
										<td class="text-center" style="vertical-align:middle;">
											<a href="javascript:fn_goDetail(<c:out value="${list.memberNo}" />)">
												${list.memberName}
											</a>
										</td>
										<td class="text-center" style="vertical-align:middle;">
						...
						<button type="button" class="btn btn-primary" onclick="member_create();">회원등록</button>
						<button type="button" class="btn btn-primary" onclick="dept_view();">부서보기</button>
	                </div>
	                <!-- /.panel-body -->
	            </div>
	            <!-- /.panel -->            
