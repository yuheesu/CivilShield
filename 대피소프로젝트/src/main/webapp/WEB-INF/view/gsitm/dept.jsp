...
<html>
	<head>
		...
		function fn_goDetail(seq){
			...
			var form = document.getElementById("memberVO");
			form.action = "/gsitm/memberbydept.do";
			form.submit();
		}
		
		function dept_create(){
			location.href="/gsitm/writedept.do";
		}
		
		
		function memberbydept(){
			location.href="/gsitm/memberbydept.do";
		}
		</script>
	</head> 
	<body>
		...
		<div class="row">
	        <div class="col-lg-12">
	            ...
	            <div class="panel panel-default">
	                <div class="panel-heading">부서 목록조회</div>
	                <!-- /.panel-heading -->
	                <div class="panel-body">                	
	                    <div class="dataTable_wrapper">
	                        <table class="table table-striped table-bordered table-hover dt-responsive" id="dataTables-ex04" width="100%" 
	                        	border = "2" data-order='[[ 0, "asc" ],[ 1, "asc" ]]' data-page-length='10'>
	                            <thead>
	                                <tr>	
	                                	<th class="text-center" width="25%">부서번호</th>					
	                                    <th class="text-center" width="*">부서이름</th>
	                                </tr>
	                            </thead>
	                            <tbody>							
					            <c:forEach var="list" items="${deptModelList}" varStatus="status">
						            <tr>
										<td class="text-center" style="vertical-align:middle;">						
												${list.deptNo}							
										</td>
										<td class="text-center" style="vertical-align:middle;">
											<a href="/gsitm/memberbydept.do?deptNo=${list.deptNo}">
												${list.deptName}
											</a>
										</td>
									</tr>
						...
						<button type="button" class="btn btn-primary" onclick="dept_create();">부서등록</button>
						<button type="button" class="btn btn-primary" onclick="deptForMember_view();">부서별멤버</button>
	                </div>
	                <!-- /.panel-body -->
	            </div>
	            <!-- /.panel -->            
